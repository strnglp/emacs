...
* General appearance
  ...
  #+begin_src emacs-lisp
    ...
    ;; This is set to the same number for both machines temporarily for testing
    (let ((font-size (if (string= (system-name) "thinkpad") 130 180)))
...
* Syntax highlighting and completion in programming modes
  ...
  #+begin_src emacs-lisp
    ...
    ;; Omnisharp LSP client and server manager
